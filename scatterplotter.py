...
for r in range(48):
    plt.plot([x[r] for i in range(1000)],C[r],'.k', alpha=.02)
scatter, = plt.plot([-10 for i in range(1000)],C[r],'.k')

plt.legend([meanplot, minplot, stdplot, scatter],['Mean C', 'Max/min C', r'$\sigma$', 'Simulations'], loc=1)
